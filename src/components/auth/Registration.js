              ...
              >
                ...
                {country.map((c) => (
                  ...
                  <div className="mt-6 text-center">
                    <p className="font-[poppins] font-normal text-[14px] text-gray-600">Have an account ? <span   className="cursor-pointer pl-1 text-[#BCA44E] underline"><a href="./login"> Login here</a></span> </p>
                  </div>
                </div>
              </div>
            </div>
